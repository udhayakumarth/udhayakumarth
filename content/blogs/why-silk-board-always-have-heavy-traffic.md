...
Currently this is a entry for Highway. This where the problem starts. Since the busses just stop after this opening. It will be a bad idea to have this as entry. So I have made it as exit. So the busses which stops after this opening in highway is not blocking one flow of traffic.
